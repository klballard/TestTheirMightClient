...
const SingleFight = (props) => {
   ...
   function sum(input){
    ...
    return(
        <div>
            <div style={{ marginTop:'140px', textAlign:'center'}}><h4>Pit two fighters against each other and see who wins!</h4></div>
            <div>
            <Row>
            <Col>
            <Card style={{ textAlign:'center', height:'500px', width:'300px', marginTop:'140px', marginLeft:'auto', marginRight:'120px'}}>
                <Col>
            ...
            <Col>
            <Card style={{ textAlign:'center', height:'500px', width:'300px', marginTop:'140px', marginLeft:'120px', marginRight:'auto'}}>
                <Col>
